...
// Multiplies the render target size on top of the user's resolution setting, for thermal quality
// scaling. 1.0 = untouched.
void set_thermal_render_factor(float factor);void set_frame_buffer_aspect_fit(bool fit);
